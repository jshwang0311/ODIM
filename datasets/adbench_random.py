...
from base.adbench_random_dataset import AdBench_Random_Dataset
from .preprocessing import create_semisupervised_setting

import torch


class AdBenchRandomDataset(BaseADDataset):
    ...
    def __init__(self, root: str, dataset_name: str, n_known_outlier_classes: int = 0, ratio_known_normal: float = 0.0,
        ...
        # Get train set
        train_set = AdBench_Random_Dataset(root=self.root, dataset_name=dataset_name, train=True, feature_range = feature_range, random_state=random_state,
                                download=True)
        ...
        # Get test set
        self.test_set = AdBench_Random_Dataset(root=self.root, dataset_name=dataset_name, train=False, feature_range = feature_range, random_state=random_state)

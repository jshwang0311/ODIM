...
if __name__ == "__main__":
    ...
    for normal_class_idx in range(len(normal_class_list)):
        ...
        for seed_idx in range(len(data_seed_list)):
            ...
            log_file = save_dir + '/log_'+dataset_name+'_trainOption'+ train_option + '_normal' + str(normal_class) +'_pol05.txt'
            ...
            ens_loss.to_csv(os.path.join(save_score_dir,'score_data_pol05.csv'),index=False)
            test_ens_loss.to_csv(os.path.join(save_score_dir,'test_score_data_pol05.csv'),index=False)
        ...
        train_df.to_csv(os.path.join(save_metric_dir,f'ODIM_light{batch_size}_{filter_net_name}_train_result_pol05.csv'))
        ...
        test_df.to_csv(os.path.join(save_metric_dir,f'ODIM_light{batch_size}_{filter_net_name}_test_result_pol05.csv'))

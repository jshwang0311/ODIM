...
tr_file_name_list = [
                'ODIM_light512_%s_mlp_vae_gaussian_fr0.5_1.0_train_result.csv',
                'ODIM_light512_%s_mlp_vae_gaussian_fr-1.0_0.0_train_result.csv'
                ]
ts_file_name_list = [
                'ODIM_light512_%s_mlp_vae_gaussian_fr0.5_1.0_test_result.csv',
                'ODIM_light512_%s_mlp_vae_gaussian_fr-1.0_0.0_test_result.csv'
                ]

col_name_list = ['ODIM_FR0.5_1.0','ODIM_FR-1.0_0.0']
...
total_tr_result_list[tr_reorder_colname].to_csv(os.path.join(result_dir_path,'train_tabular_feature_range_summary.csv'))
total_ts_result_list[ts_reorder_colname].to_csv(os.path.join(result_dir_path,'test_tabular_feature_range_summary.csv'))

...
dataset_list = [
                '20news_0', '20news_1', '20news_2', '20news_3', '20news_4', '20news_5', 'agnews_0', 'agnews_1', 'agnews_2', 'agnews_3'
               ]

result_dir_path = '/home/x1112480/ODIM/Results'
tr_file_name_list = [
                'ODIM_fully_fit_AD_RoBERTa512_mlp_vae_gaussian_train_result.csv',
                'deepSVDD_ensemble_AD_RoBERTa_mlp_train_result.csv'
                ]
ts_file_name_list = [
                'ODIM_fully_fit_AD_RoBERTa512_mlp_vae_gaussian_test_result.csv',
                'deepSVDD_ensemble_AD_RoBERTa_mlp_test_result.csv'
                ]
...
total_tr_result_list[tr_reorder_colname].to_csv(os.path.join(result_dir_path,'train_RoBERTa_summary_rebutal.csv'))
total_ts_result_list[ts_reorder_colname].to_csv(os.path.join(result_dir_path,'test_RoBERTa_summary_rebutal.csv'))

...
if __name__ == "__main__":
    ...
    for normal_class_idx in range(len(normal_class_list)):
        ...
        for seed_idx in range(len(data_seed_list)):
            ...
            save_dir = os.path.join(f'Results/{dataset_name}/Convention_time',f'log{seed}')
            os.makedirs(save_dir, exist_ok=True)
            save_score_dir = os.path.join(f'Results/{dataset_name}/Convention_time',f'score{seed}')
            ...
            logger.info('Running time: %.4f' % running_time)

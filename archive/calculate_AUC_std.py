...
if __name__ == "__main__":
    ...
    for normal_class_idx in range(len(normal_class_list)):
        ...
        for seed_idx in range(len(data_seed_list)):
            ...
            log_file = save_dir + '/log_'+dataset_name+'_trainOption'+ train_option + '_normal' + str(normal_class) +'1.txt'
        ...
        train_df.to_csv(os.path.join(save_metric_dir,'ODIM_std1_train_result.csv'))
        ...
        test_df.to_csv(os.path.join(save_metric_dir,'ODIM_std1_test_result.csv'))

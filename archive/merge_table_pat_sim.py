...
dataset_list = [
                'annthyroid', 'breastw', 'cover', 'glass', 'ionosphere', #'letter', 
                'mammography', 'musk', #'optdigits',
                'pendigits', 'pima', #'speech', 'vertebral', 
                'vowels', 'wbc', 'arrhythmia', 'cardio', 'satellite', 
                'satimage-2', 'shuttle', 'thyroid'
               ]

result_dir_path = '/home/x1112480/ODIM/Results'
tr_file_name_list = [
                'ODIM_light_%s_mlp_vae_gaussian_pat10_train_result.csv',
                'ODIM_light_%s_mlp_vae_gaussian_pat20_train_result.csv',
                'ODIM_light_%s_mlp_vae_gaussian_pat50_train_result.csv',
                'ODIM_light_%s_mlp_vae_gaussian_pat100_train_result.csv',
                'ODIM_light_%s_mlp_vae_gaussian_pat150_train_result.csv',
                #'ODIM_light_%s_mlp_vae_gaussian_pat200_train_result.csv'
                ]
ts_file_name_list = [
                'ODIM_light_%s_mlp_vae_gaussian_pat10_test_result.csv',
                'ODIM_light_%s_mlp_vae_gaussian_pat20_test_result.csv',
                'ODIM_light_%s_mlp_vae_gaussian_pat50_test_result.csv',
                'ODIM_light_%s_mlp_vae_gaussian_pat100_test_result.csv',
                'ODIM_light_%s_mlp_vae_gaussian_pat150_test_result.csv',
                #'ODIM_light_%s_mlp_vae_gaussian_pat200_test_result.csv'
                ]
...
total_tr_result_list[tr_reorder_colname].to_csv(os.path.join(result_dir_path,'train_tabular_pat_summary.csv'))
total_ts_result_list[ts_reorder_colname].to_csv(os.path.join(result_dir_path,'test_tabular_pat_summary.csv'))

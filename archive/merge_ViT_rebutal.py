...
dataset_list = [
                'CIFAR10_0', 'CIFAR10_1', 'CIFAR10_2', 'CIFAR10_3', 'CIFAR10_4', 'CIFAR10_5', 'CIFAR10_6', 'CIFAR10_7', 'CIFAR10_8', 'CIFAR10_9', 'MNIST-C_brightness', 'MNIST-C_canny_edges', 'MNIST-C_dotted_line', 'MNIST-C_fog', 'MNIST-C_glass_blur', 'MNIST-C_identity', 'MNIST-C_impulse_noise', 'MNIST-C_motion_blur', 'MNIST-C_rotate', 'MNIST-C_scale', 'MNIST-C_shear', 'MNIST-C_shot_noise', 'MNIST-C_spatter', 'MNIST-C_stripe', 'MNIST-C_translate', 'MNIST-C_zigzag', 'MVTec-AD_bottle', 'MVTec-AD_cable', 'MVTec-AD_capsule', 'MVTec-AD_carpet', 'MVTec-AD_grid', 'MVTec-AD_hazelnut', 'MVTec-AD_leather', 'MVTec-AD_metal_nut', 'MVTec-AD_pill', 'MVTec-AD_screw', 'MVTec-AD_tile', 'MVTec-AD_toothbrush', 'MVTec-AD_transistor', 'MVTec-AD_wood', 'MVTec-AD_zipper'
               ]

result_dir_path = '/home/x1112480/ODIM/Results'
tr_file_name_list = [
                'ODIM_fully_fit_AD_ViT256_mlp_vae_gaussian_train_result.csv',
                'deepSVDD_ensemble_AD_ViT_mlp_train_result.csv',
                ]
ts_file_name_list = [
                'ODIM_fully_fit_AD_ViT256_mlp_vae_gaussian_test_result.csv',
                'deepSVDD_ensemble_AD_ViT_mlp_test_result.csv',
                ]

col_name_list = ['ODIM_Fully_fit','DeepSVDD_Ens']
...
for dataset in dataset_list:
    ...
    for file_idx in range(len(tr_file_name_list)):
        ...
        if 'MVTec' in dataset:
            tr_file_name = tr_file_name.replace('256','512')
            ts_file_name = ts_file_name.replace('256','512')
        try:
...
total_tr_result_list[tr_reorder_colname].to_csv(os.path.join(result_dir_path,'train_ViT_summary_rebutal.csv'))
total_ts_result_list[ts_reorder_colname].to_csv(os.path.join(result_dir_path,'test_ViT_summary_rebutal.csv'))

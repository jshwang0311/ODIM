...
tr_file_name_list = [
                ...
                'LoF_train_result_AD_VResNet.csv',
                'iF_train_result_AD_VResNet.csv',
                'COPOD_train_result_AD_VResNet.csv',
                'ECOD_train_result_AD_VResNet.csv',
                'deepSVDD_AD_VResNet_mlp_train_result.csv'
                ]
ts_file_name_list = [
                'ODIM_light512_AD_VResNet_mlp_vae_gaussian_test_result.csv',
                'OneClassSVM_test_result_AD_VResNet.csv',
                'LoF_test_result_AD_VResNet.csv',
                'iF_test_result_AD_VResNet.csv',
                'COPOD_test_result_AD_VResNet.csv',
                'ECOD_test_result_AD_VResNet.csv',
                'deepSVDD_AD_VResNet_mlp_test_result.csv'
                ]
...
total_tr_result_list[tr_reorder_colname].to_csv(os.path.join(result_dir_path,'train_ResNet_summary.csv'))
total_ts_result_list[ts_reorder_colname].to_csv(os.path.join(result_dir_path,'test_ResNet_summary.csv'))

...
if __name__ == "__main__":
    ...
    for normal_class_idx in range(len(normal_class_list)):
        ...
        for seed_idx in range(len(data_seed_list)):
            ...
            save_dir = os.path.join(f'Results/{dataset_name}/ODIM_light{batch_size}',f'log{seed}')
            os.makedirs(save_dir, exist_ok=True)
            save_score_dir = os.path.join(f'Results/{dataset_name}/ODIM_light{batch_size}',f'score{seed}')
        ...
        train_df.to_csv(os.path.join(save_metric_dir,f'ODIM_light{batch_size}_train_result.csv'))
        ...
        test_df.to_csv(os.path.join(save_metric_dir,f'ODIM_light{batch_size}_test_result.csv'))

...
if __name__ == "__main__":
    ...
    for normal_class_idx in range(len(normal_class_list)):
        ...
        for seed_idx in range(len(data_seed_list)):
            ...
            save_dir = os.path.join(f'Results/{dataset_name}/ODIM_light{batch_size}_{filter_net_name}_fr{feature_range[0]}_{feature_range[1]}',f'log{seed}')
            os.makedirs(save_dir, exist_ok=True)
            save_score_dir = os.path.join(f'Results/{dataset_name}/ODIM_light{batch_size}_{filter_net_name}_fr{feature_range[0]}_{feature_range[1]}',f'score{seed}')
        ...
        train_df.to_csv(os.path.join(save_metric_dir,f'ODIM_light{batch_size}_{filter_net_name}_fr{feature_range[0]}_{feature_range[1]}_train_result.csv'))
        ...
        test_df.to_csv(os.path.join(save_metric_dir,f'ODIM_light{batch_size}_{filter_net_name}_fr{feature_range[0]}_{feature_range[1]}_test_result.csv'))

...
class CIFAR10_LeNet_GMVariationalAutoencoder_noVar(nn.Module):
    """
    ...
    def __init__(self, rep_dim=128,n_cluster=1):
        super(CIFAR10_LeNet_GMVariationalAutoencoder_noVar, self).__init__()
    ...
    def gen_z_information(self):        
        ...
        return self.z_mu_ps(self.idle_input)

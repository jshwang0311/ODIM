...
class AD_mlp_GMVariationalAutoencoder_fixcluster_gaussian(nn.Module):
    """
    ...
    def __init__(self, x_dim=274, h_dims=[128, 64], rep_dim=32, bias=False, n_cluster=1):
        super(AD_mlp_GMVariationalAutoencoder_fixcluster_gaussian,self).__init__()
        ...
        self.p_cluster = nn.Parameter(torch.zeros(n_cluster) , requires_grad=False)
